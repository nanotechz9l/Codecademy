...
def puts_1_to_10 # define new method
  (1..10).each { |i| puts i } # for each iteration of 1..10, assign |i| code block, and print.
end

puts_1_to_10 # Ignore this for now. We'll explain it soon! Returns value of method.